...
class Complex(ModelMeta, InferenceMeta):
    ...
    def def_loss(self):
        ...
        regul_term = tf.reduce_mean(pos_h_e_real**2 + pos_h_e_img**2) + tf.reduce_mean(pos_r_e_real**2 + pos_r_e_img**2) + tf.reduce_mean(pos_t_e_real**2 + pos_t_e_img**2) + \
                     tf.reduce_mean(neg_h_e_real**2 + neg_h_e_img**2) + tf.reduce_mean(neg_r_e_real**2 + neg_r_e_img**2) + tf.reduce_mean(neg_t_e_real**2 + neg_t_e_img**2) 
