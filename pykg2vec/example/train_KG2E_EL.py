...
def main(_):
    parser = ArgumentParser(description='Knowledge Graph Embedding with KG2E expected likelihood')
    parser.add_argument('-b', '--batch', default=2480, type=int, help='batch size')
