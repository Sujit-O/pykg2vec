...
def main(_):
    parser = ArgumentParser(description='Knowledge Graph Embedding with TransH')
    parser.add_argument('-b', '--batch', default=1200, type=int, help='batch size')
    ...
    parser.add_argument('-lr', '--learn_rate', default=0.005, type=float, help='learning rate')
    ...
    data_handler = DataPrep(name_dataset=args.dataset, sampling="uniform", algo='TransH')
