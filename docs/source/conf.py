...
ver_file = os.path.join(os.path.abspath('../../pykg2vec/'), '_version.py')
...
latex_documents = [
  ('index', 'pykg2vec.tex', u'pykg2vec Documentation',
   u'Sujit Rokka Chhetri, Shih-Yuan Yuand, Ahmet Salih Aksakal, Palash Goyal and Arquimedes Canedo', 'manual'),
]
...
man_pages = [
    ('index', 'pykg2vec', u'pykg2vec Documentation',
     [u'Sujit Rokka Chhetri, Shih-Yuan Yuand, Ahmet Salih Aksakal, Palash Goyal and Arquimedes Canedo'], 1)
]
